...
專為**中原大學 (CYCU) iLearning 2.0** 平台打造的全方位體驗優化油猴腳本（UserScript）。徹底告別 Moodle 笨重的播放限制、iPadOS 滿版時消不掉的網址列、微弱的課堂錄音，以及繁瑣的逐檔下載作業！
...
### 1. 影音播放全面解鎖
- **自由拖曳懸浮面板**：支援滑鼠左鍵與 iPadOS/iOS 多點觸控拖曳，具備自動防出界保護，並自動記憶上一次擺放座標。
- **Video 全螢幕**：針對 iPadOS Safari 呼叫底層原生播放器，**徹底隱藏上方網址列與分頁標籤**。
- **進度條自由快轉 / 倒退**：秒級快轉/倒退（10s / 30s），徹底繞過系統進度防跳轉限制。
- **Web Audio 600% 爆音引擎**：內建硬體級 GainNode 數位放大，並設有「一鍵 MAX 600%」按鈕，聽清楚老師微弱的麥克風收音。
- **單檔 MP4 影片離線直載**：自動解析原廠 MP4 高畫質直鏈，一鍵儲存離線複習。
...
###  3. 介面淨化與流暢大綱
- **課程大綱漂浮按鈕**：左側隨時可一鍵呼叫與收折課程章節目錄（Drawer Index）。
- **簡潔介面模式**：一鍵將雜亂的課程模組重組為乾淨俐落的週次/分類摺疊選單。
- **智慧 PDF 助理**：提供專注閱讀、深色護眼模式、頁碼跳轉與本機隨堂筆記導出功能。
...
| **iPadOS / iOS** | Safari | [Userscripts](https://apps.apple.com/app/userscripts/id1463298887) 或 
[Stay 2]([https://apps.apple.com/app/stay-for-safari/id1591620924](https://apps.apple.com/tw/app/stay-for-safari-%E4%BD%BF%E7%94%A8%E8%80%85%E8%85%B3%E6%9C%AC%E8%88%87%E5%BB%A3%E5%91%8A%E6%94%94%E6%88%AA%E6%93%B4%E5%85%85/id1591620171)) |
...
1. 點擊安裝連結：  
   🔗 **[點此前往 Greasy Fork 安裝頁面](https://greasyfork.org/zh-TW/scripts/597066-%E4%B8%AD%E5%8E%9F-ilearning-2-0-%E9%AB%94%E9%A9%97%E5%A2%9E%E5%BC%B7)**
2. 點擊綠色的 **「安裝此腳本 (Install this script)」** 按鈕。
3. 在跳出的 Tampermonkey 確認視窗中，點擊 **「安裝 (Install)」**。
4. 重新整理或登入 [中原大學 iLearning 2.0](https://ilearning.cycu.edu.tw/)，即可看到增強介面生效！
...
- 平常在 100% 以內使用原生音量。
- 當遇到老師聲音太小、麥克風收音不良時，直接拖動滑桿至 100%~600%，或點擊紅色的 **「MAX」** 按鈕立即 600% 聲音！
