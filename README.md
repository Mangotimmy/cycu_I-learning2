...
### 1. 影音播放全面解鎖
- **自由拖曳懸浮面板**：支援滑鼠左鍵與 iPadOS/iOS 觸控拖曳，具備自動防出界保護，並自動記憶上一次擺放座標。
...
1. **安裝管理工具**：
   - Safari 使用者：App Store 安裝 **[Stay 2](https://apps.apple.com/app/stay-for-safari/id1591620924)**。
...
本腳本內建官方元資料標頭（Metadata）：
- `@updateURL`：自動檢查新版本號碼。
- `@downloadURL`：背景無感靜默更新最新功能。
