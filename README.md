...
- **AI 即時字幕引導**：整合瀏覽器免費用戶端 AI 語音轉文字與即時繁中翻譯引導。
...
- **修復 1980 年解壓縮時間戳記**：採用 MS-DOS 16-bit 真實時間運算，解壓縮後保留真實日期。
...
| **iPadOS / iOS** | Safari | [Userscripts](https://apps.apple.com/app/userscripts/id1463298887) 或 [Stay 2](https://apps.apple.com/app/stay-for-safari/id1591620924) |
...
- 平常在 100% 以內使用原生音量。
- 當遇到老師聲音太小、麥克風收音不良時，直接拖動滑桿至 100%~600%，或點擊紅色的 **「MAX」** 按鈕立即啟動 600% 增益！
